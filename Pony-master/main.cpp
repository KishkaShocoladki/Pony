...
int main()
    ...
    while (true)
    {
        ...
        if (txMouseButtons() & 1 &&                //ïåðâàÿ êíîïêà
            txMouseX() >= 100 &&
            txMouseX() <= 530 &&
            txMouseY() >=   0 + 30 &&
            txMouseY() <= 140 - 45)
        ...
        if  (txMouseX() >= 100 &&
            ...
            txMouseY() <= 140 - 45)
        {
            txTextOut(500, 50, "ÏÎÍÈ");
        }

        if (txMouseButtons() & 1 &&                //âòîðàÿ êíîïêà
            txMouseX() >= 100 &&
            txMouseX() <= 530 &&
            txMouseY() >= 130 + 30 &&
            txMouseY() <= 260 - 45)
        ...
        if  (txMouseX() >= 100 &&
            ...
            txMouseY() <= 260 - 45)
        {
            txTextOut(500, 170, "ÕÂÎÑÒ");
        }


        if (txMouseButtons() & 1 &&                //òðåòüÿ êíîïêà
            txMouseX() >= 100 &&
            txMouseX() <= 530 &&
            txMouseY() >= 260 + 30 &&
            txMouseY() <= 390 - 45)
        ...
        if  (txMouseX() >= 100 &&
            ...
            txMouseY() <= 390 - 45)
        {
            txTextOut(500, 300, "ÊÎÏÛÒÀ");
        }

        if (txMouseButtons() & 1 &&                //÷åòâ¸ðòàÿ êíîïêà
            txMouseX() >= 100 &&
            txMouseX() <= 530 &&
            txMouseY() >= 390 + 30 &&
            txMouseY() <= 520 - 45)
        ...
        if  (txMouseX() >= 100 &&
            ...
            txMouseY() <= 520 - 45)
        {
            txTextOut(500, 430, "ÃÎËÎÂÀ");
        }

        if (txMouseButtons() & 1 &&                //ïÿòàÿ êíîïêà
            txMouseX() >= 100 &&
            txMouseX() <= 530 &&
            txMouseY() >= 520 + 30 &&
            txMouseY() <= 650 - 45)
